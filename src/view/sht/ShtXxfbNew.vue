                ...
                <el-col :span="18" :offset="2">
                    <el-form ref="editForm" :rules="addRules" :model="editForm" label-width="90px" label-position="right">
                        ...
                        <el-form-item label="主题图片：">
                            <upload v-on:showPreview="showPreviews" :message="editForm.img"></upload>
                        </el-form-item>
                        <el-form-item label="正文内容：">
                            <el-input type="textarea" placeholder="请输入内容..."></el-input>
                        </el-form-item>
                        <el-form-item label="正文图片：">
                            <upload v-on:showPreview="showPreviews1" :message="editForm.img"></upload>
                        </el-form-item>
        ...
        data () {
            return {
                ...
                editForm: {
                    ...
                    banben:'',
                    sendTime:'',
                    img:this.$root._data.imgUrl,
                    img1:this.$root._data.imgUrl
                },
                cities: [],
                auditData: {
                    name:'商户开通失败',
