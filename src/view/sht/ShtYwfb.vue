                    ...
                    <el-form ref="addForm" :rules="addRules" :model="addForm" label-width="110px">
                        ...
                        <el-form-item label="选择业务：" v-if="$store.state.common.jumpService">
                            <el-select v-model="addForm.yewu" placeholder="请选择业务">
                                <el-option v-for="item in $root._data.businessList" :key='item.id' :label="item.label" :value="item.value"></el-option>
                            </el-select>
                        </el-form-item>
                        <div v-else>
        ...
        <el-dialog title="业务详情" custom-class="dialogDetail" v-model="dialogDetail" size="small">
            ...
            <div class="addbox">
                ...
                <el-row>
                    ...
                    <el-col :span="12" class="item">
                        <label class="imgLabel">标识图片：</label><img width="140px" :src="detailData.imgUrl?detailData.imgUrl:$root._data.imgUrl" alt="">
                    </el-col>
                </el-row>
            </div>
            <div class="addbox">
