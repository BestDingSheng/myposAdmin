                    ...
                    <el-form :model="addData" :rules="addRule" ref="addData" :label-width="'100px'">
                        ...
                        <el-form-item label="注册时长" :label-width="'100px'" prop="times">
                            ...
                            <el-col :span="12" :offset="2" v-show="showTime">
                                ...
                                <el-col :span="2" :offset="2" class="dxwhText">天</el-col>
                            </el-col>
                            <el-col :span="12" :offset="2" v-show="!showTime">
                                <el-col :span="10">
                                    <el-form-item>
                        ...
                        <el-form-item label="交易总笔数" prop="tradeNum">
                            <el-row>
                                ...
                                <el-col :span="12" :offset="2" v-show="showNum">
                                    ...
                                    <el-col :span="2" :offset="2" class="dxwhText">次</el-col>
                                </el-col>
                                <el-col :span="12" :offset="2" v-show="!showNum">
                                    <el-col :span="10">
                                        <el-form-item>
                        ...
                        <el-form-item label="交易总金额"  prop="trade">
                            <el-row>
                                ...
                                <el-col :span="12" :offset="2" v-show="showTrade">
                                    ...
                                    <el-col :span="2" :offset="2" class="dxwhText">元</el-col>
                                </el-col>
                                <el-col :span="12" :offset="2" v-show="!showTrade">
                                    <el-col :span="10">
                                        <el-form-item>
        ...
        methods: {
            ...
            leadConfirm () {
                ...
                axios.get("src/json/test.json").then(function(res){
                    ...
                    var data=res.data.data.result;
                    if(code==0){
                        vm.leadDataVisible = false;
                        vm.$refs.drdx.resetFields();
                        vm.$message({
                            message: message,
                            type: 'success'
                        });
