<template>
    <el-row>
        ...
        <el-col :span="24" class="toolbar">
            <el-form :inline="true" :model="formInline" ref="formInline" class="demo-form-inline">
                ...
                <el-form-item prop="state">
                    <el-select v-model="formInline.banmian" clearable placeholder="请选择版面">
                        <el-option
        ...
        <el-dialog title="新建广告" custom-class="dialogAdd" v-model="dialogAdd" size="small">
            <el-row :gutter="20">
                <el-col :span="16" :offset="3">
                    <el-form ref="form" :rules="addRules" :model="addForm" label-width="150px">
                        ...
                        <el-form-item label="版面选择：">
                            <el-select v-model="addForm.banmian" clearable placeholder="请选择">
                                <el-option v-for="item in $root._data.pageList" :key='item.id' :label="item.label" :value="item.value"></el-option>
                            </el-select>
                        </el-form-item>
                        <el-form-item label="栏位选择：">
                            <el-select v-model="addForm.lanwei" clearable placeholder="请选择">
                                <el-option v-for="item in $root._data.columnList" :key='item.id' :label="item.label" :value="item.value"></el-option>
                            </el-select>
                        </el-form-item>
                        <el-form-item label="广告类型：">
                            <el-select v-model="addForm.type" clearable placeholder="请选择">
                                <el-option v-for="item in $root._data.adTypeList" :key='item.id' :label="item.label" :value="item.value"></el-option>
                            </el-select>
                        </el-form-item>
                        <el-form-item label="内容图片：" class="adCon" v-if="conType">
                            <el-upload
        ...
        <!--详情-->
        <el-dialog title="广告详情" custom-class="dialogDetail" v-model="dialogDetail" size="small">
            <div class="addbox">
                <el-row>
                    <el-col :span="12" class="item">
