    ...
    <el-row>
        ...
        <el-dialog title="新建业务" custom-class="dialogAdd" v-model="dialogAdd" size="small">
            <el-row :gutter="20">
                <el-col :span="16" :offset="4">
                    <el-form ref="addForm" :model="addForm" :rules="addRule" label-width="110px">
                        ...
                        <el-form-item label="栏位：" prop="lanwei">
                        ...
                        <el-form-item label="编辑内容：" >
                            <el-form-item style="margin-bottom:5px;" prop="text1">
                                <el-input placeholder="文本一"></el-input>
                            </el-form-item>
                            <el-form-item prop="text2">
                                <el-input placeholder="文本二"></el-input>
                            </el-form-item>
                        </el-form-item>
                        <el-form-item label="图片选择：" class="adCon" prop="imgUrl">
                            <el-upload
                        ...
                        <el-form-item label="选择对象：" prop="duixiang">
                            <el-col :span="12">
                                <el-select v-model="addForm.duixiang" placeholder="请选择对象">
                                    <el-option
                        ...
                        <el-form-item label="选择业务：" v-if="$store.state.common.jumpService" prop="yewu">
                        ...
                        <div v-else>
                            ...
                            <el-form-item label="网页链接：">
                                <el-input placeholder="请输入网页链接" prop="url"></el-input>
                            </el-form-item>
                        </div>
                        <el-form-item label="业务发布日期:" prop="startDate">
                            <el-date-picker
        ...
        <el-dialog title="业务详情" custom-class="dialogDetail" v-model="dialogDetail" size="small">
            <div class="addbox">
                ...
                <el-row>
                    <el-col :span="12" class="item">
                        <label>业务名称：</label><span>{{detailData.name}}</span>
                    </el-col>
                    <el-col :span="12" class="item">
            ...
            <div class="addbox">
                ...
                <el-row>
                    ...
                    <el-col :span="12" class="item">
                        <label class="imgLabel">标识图片：</label><img class="image" :src="detailData.imgUrl?detailData.imgUrl:$root._data.imgUrl" alt="">
                    </el-col>
                </el-row>
            </div>
            <div class="addbox">
    ...
    export default {
        ...
        methods:{
             handleSearch () {
                 ...
                 axios.get("src/json/test.json").then(function(res){
