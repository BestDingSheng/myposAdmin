...
<script>
    ...
    export default {
        ...
        computed: {
            add() {
                if (this.$store.state.login.permissions["/ywgl/shxxcxToC"]) {
                    // return this.$store.state.login.permissions["/ywgl/shxxcxToC"].add;
                    let qdglPage = this.$store.state.login.permissions["/ywgl/shxxcxToC"];
